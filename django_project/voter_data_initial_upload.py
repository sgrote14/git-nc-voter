...
SCRIPT SUMMARY
    ...
    It will get called by the voter_file_check script.
"""
import django
import os
import pandas as pd
...
"""
Function accepts a DF and a dict that sets dtypes for specific columns. It returns a new dict that includes the 
specified dtypes and default dtypes (str) for all other columns.
"""
...
# Calls above function after creating required parameters
file_path = 'ncvoter34.txt'
...
# def get_create_inst(model_class, pk, **kwargs):
#     try:
#         instance = model_class.objects.get(pk=pk)
#     except model_class.DoesNotExist:
#         instance = model_class(pk=pk, **kwargs)
#         instance.save()
#
#     return instance


# Need to minimize DB queries...query DB once to collect foreign keys and create dict mapping

# Uploading to Django Model
instances = []
...
# Bulk creating objects using instances list
